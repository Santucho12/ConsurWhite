          ...
          <div className="flex flex-col items-center lg:items-center text-center">
            ...
            <div className="flex gap-3 justify-center">
              {[
                { 
                  name: "Instagram",
                  href: "https://www.instagram.com/consurwhite?igsh=MXRvY3hyajE4bXluaw==", 
                ...
                { 
                  name: "Facebook",
                  href: "https://www.facebook.com/share/1CrR9KvvU8/?mibextid=wwXIfr", 
                ...
                { 
                  name: "WhatsApp",
                  href: "https://wa.me/5492915336645", 
